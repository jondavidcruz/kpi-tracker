...
const PUBLIC_PATHS = ["/login", "/auth", "/assess", "/tv", "/api/ingest", "/api/cron", "/api/speedtest", "/api/tickets", "/api/suggestions", "/api/recording", "/manifest.webmanifest", "/icon", "/apple-icon"];
