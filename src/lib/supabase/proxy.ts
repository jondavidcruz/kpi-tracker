...
const PUBLIC_PATHS = ["/login", "/auth", "/assess", "/tv", "/api/ingest", "/api/cron", "/api/backup", "/api/buyers-admin", "/api/speedtest", "/api/tickets", "/api/suggestions", "/api/recording", "/api/cascade", "/api/telco-alert", "/manifest.webmanifest", "/icon", "/apple-icon"];
