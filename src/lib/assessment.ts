...
export const PROFILES: Record<string, Profile> = {
  ...
  collaborator:{ key: "collaborator", name: "The Collaborator", emoji: "🧩", blurb: "Supportive team player who blends warmth with reliability. Glue that keeps the group moving together.", strengths: ["Easy to work with", "Steady + encouraging", "Bridges people"], watchouts: ["Conflict-avoidant", "Defers too much"], comms: "Be inclusive and warm; invite their input.", motivate: "Team harmony, appreciation, shared wins.", seat: "Lead management / support / coordination" },
  adapter:     { key: "adapter", name: "The Adapter", emoji: "🌊", blurb: "Balanced and flexible — reads the room and shifts to whatever the moment needs. A versatile generalist.", strengths: ["Fits many roles", "Reads people well", "Comfortable with change"], watchouts: ["Can lack a clear lane", "Spreads thin"], comms: "Clarify priorities so they focus their range.", motivate: "Variety, growth, and a clear #1 priority.", seat: "Flexible — rotate to the team's biggest need" },
};
