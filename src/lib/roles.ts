...
// review when logged, but never alert. Sharyn: primarily Dispositions,
// cross-trained Acquisitions. (Michelle is Acquisitions ONLY — Jon 2026-09-28:
// "not doing dispositions anymore"; no secondary.)
