...
export default async function MeetingEditPage({ searchParams }: { searchParams: Promise<{ saved?: string }> }) {
  ...
  return (
    <div className="space-y-6">
      <SectionTitle
        title="🗓 Monday Meeting content"
        subtitle="Annual goal, editorial slides, and the training-tip backlog for the all-call deck"
        accent="bg-brand-gold"
        right={<Link href="/meeting" className="text-sm font-semibold text-brand-navy hover:underline">Open the deck →</Link>}
      />
