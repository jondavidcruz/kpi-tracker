...
const LABEL: Record<BarState, string> = { work: "Working", break: "Break", lunch: "Lunch", meeting: "Meeting", appointment: "Appointment", errand: "Errand", training: "Training", bathroom: "Bathroom", outage: "Outage", off: "Off" };
...
export function ShiftBarLegend() {
  return (
    <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-[10px] text-slate-500">
      {(["work", "break", "lunch", "meeting", "appointment", "errand", "training", "bathroom", "outage", "off"] as BarState[]).map((s) => (
