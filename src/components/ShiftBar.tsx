...
const LABEL: Record<BarState, string> = { work: "Working", break: "Break", lunch: "Lunch", meeting: "Meeting", outage: "Outage", off: "Off" };
...
export function ShiftBarLegend() {
  return (
    <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-[10px] text-slate-500">
      {(["work", "break", "lunch", "meeting", "outage", "off"] as BarState[]).map((s) => (
